...
- 게임 시작
  ...
  - 사용자로부터 3자리 수를 입력받음 
    - 입력값의 유효성 검사 
      - 서로 다른 3자리 수가 아닌 경우, `IllegalArgumentException`을 발생시키고 종료
- 게임 중
  - 사용자의 입력값과 컴퓨터가 생성한 값 비교 후 결과 생성 (스트라이크, 볼, 낫싱)
  - 숫자 비교 반복, 3스트라이크 시 게임 종료
- 게임 종료
  - 게임 종료 후 1을 입력하면 재시작, 2를 입력하면 게임 종료.
